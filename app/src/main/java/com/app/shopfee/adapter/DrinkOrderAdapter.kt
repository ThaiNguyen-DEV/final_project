...
import com.app.shopfee.adapter.DrinkOrderAdapter.DrinkOrderViewHolder
...
class DrinkOrderAdapter(private val listDrinkOrder: List<DrinkOrder?>?) :
    ...
    override fun onBindViewHolder(holder: DrinkOrderViewHolder, position: Int) {
        val drinkOrder = listDrinkOrder!![position] ?: return
        GlideUtils.loadUrl(drinkOrder.image, holder.imgDrink)
